...
- [Python Documentation - The Python Tutorial](https://docs.python.org/3/tutorial/index.html)
...
- [Rosalind - learning bioinformatics through problem solving](https://rosalind.info/problems/locations/)

  ##### *Special Topics in Python*

  - [Luciano Ramalho - Fluent Python: Clear, Concise, and Effective Programming](https://www.amazon.com/Luciano-Ramalho-ebook/dp/B09WZJMMJP?ref_=ast_author_dp)  (££), [Example Code](https://github.com/fluentpython/example-code-2e)

  - [Ned Batchelder - Blog: #python](https://nedbatchelder.com/blog/tag/python.html)


### Git and Github

- [Hubspot - An Intro to Git and GitHub for Beginners (Tutorial)](https://product.hubspot.com/blog/git-and-github-tutorial-for-beginners)


### Mathematics and Statistics

- [Youtube - 3Blue1Brown](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw)
- [Youtube - StatQuest with Josh Starmer](https://www.youtube.com/@statquest)